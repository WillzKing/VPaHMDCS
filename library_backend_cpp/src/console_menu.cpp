...
int main() {
    ...
    while (true) {
        ...
        case 3: {
            string f = readLine("Поле сортировки (title/author/genre/year/rating/price/isbn/...): ");
        ...
        case 6: {
            ...
            if (ch > 0 && static_cast<size_t>(ch) <= cands.size()) {
                ...
                b.isbn = c.isbn; b.publisher = c.publisher; b.genre = c.genre;
...
case 7: { /* Google Books */
    ...
    if (cands.empty()) { 
        ...
        cout << "Проверьте:\n";
        cout << "  1. API ключ: echo $env:GOOGLE_BOOKS_API_KEY\n";
    ...
    break;
        ...
        case 10: {
            ...
            input = readLine("Формат [" + b.format + "]: ");
            if (!input.empty()) b.format = input;
            ...
            b.price = readDouble("Цена [" + to_string(b.price) + "]: ", b.price);
